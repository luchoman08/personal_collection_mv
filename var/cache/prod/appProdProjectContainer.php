...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.reportes_controller' => 'getApp_ReportesControllerService',
    ...
    /*
     * Gets the 'app.reportes_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \TinkerSoft\ReportesBundle\Controller\ReportesController A TinkerSoft\ReportesBundle\Controller\ReportesController instance.
     */
    protected function getApp_ReportesControllerService()
    {
        return $this->services['app.reportes_controller'] = new \TinkerSoft\ReportesBundle\Controller\ReportesController();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => 'localhost', 'port' => 5432, 'dbname' => 'proyecto', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ed7c33e1dc706323a9c813b3beb1bfcf3028460fb85c7f2a2b5729daef8ab774');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/TinkerSoft/ReportesBundle/Resources/views'), 'TinkerSoftReportes');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5785f5b3e17b15.52504887')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TinkerSoftReportesBundle' => 'TinkerSoft\\ReportesBundle\\TinkerSoftReportesBundle',
            ),
