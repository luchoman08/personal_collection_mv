 ...
 */
class Coleccion extends \TinkerSoft\FuncionesSitioBundle\Entity\Coleccion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Coleccion' . "\0" . 'id', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Coleccion' . "\0" . 'nombre', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Coleccion' . "\0" . 'tipo', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Coleccion' . "\0" . 'fechaCreacion', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Coleccion' . "\0" . 'idUsuario'];
        }
