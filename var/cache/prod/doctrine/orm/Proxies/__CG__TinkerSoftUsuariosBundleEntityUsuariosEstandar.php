 ...
 */
class UsuariosEstandar extends \TinkerSoft\UsuariosBundle\Entity\UsuariosEstandar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TinkerSoft\\UsuariosBundle\\Entity\\UsuariosEstandar' . "\0" . 'id', '' . "\0" . 'TinkerSoft\\UsuariosBundle\\Entity\\UsuariosEstandar' . "\0" . 'nombres', '' . "\0" . 'TinkerSoft\\UsuariosBundle\\Entity\\UsuariosEstandar' . "\0" . 'apellidos', '' . "\0" . 'TinkerSoft\\UsuariosBundle\\Entity\\UsuariosEstandar' . "\0" . 'nickname', '' . "\0" . 'TinkerSoft\\UsuariosBundle\\Entity\\UsuariosEstandar' . "\0" . 'correoElectronico', '' . "\0" . 'TinkerSoft\\UsuariosBundle\\Entity\\UsuariosEstandar' . "\0" . 'password', '' . "\0" . 'TinkerSoft\\UsuariosBundle\\Entity\\UsuariosEstandar' . "\0" . 'rol', '' . "\0" . 'TinkerSoft\\UsuariosBundle\\Entity\\UsuariosEstandar' . "\0" . 'estado'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UsuariosEstandar $proxy) {
