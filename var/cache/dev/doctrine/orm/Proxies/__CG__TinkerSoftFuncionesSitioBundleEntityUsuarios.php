 ...
 */
class Usuarios extends \TinkerSoft\FuncionesSitioBundle\Entity\Usuarios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Usuarios' . "\0" . 'id', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Usuarios' . "\0" . 'nombres', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Usuarios' . "\0" . 'apellidos', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Usuarios' . "\0" . 'nickname', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Usuarios' . "\0" . 'correoElectronico', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Usuarios' . "\0" . 'password', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Usuarios' . "\0" . 'rol', '' . "\0" . 'TinkerSoft\\FuncionesSitioBundle\\Entity\\Usuarios' . "\0" . 'estado'];
        }
